                ...
                {{ asset('templateAdmin/assets/images/faces/2.jpg') }} @endif"
                        ...
                        <div class="text">
                            <h6 class="user-dropdown-name">
                                {{ auth()->guard('operator_kasir')->user() ? auth()->guard('operator_kasir')->user()->name : (auth()->user() ? auth()->user()->name : '') }}
                            </h6>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg"
                        ...
                        <li><a class="dropdown-item" href="{{ route('admin.profile', auth()->user() ? auth()->user()->kode : '') }}">My Account</a></li>
                        <li>
