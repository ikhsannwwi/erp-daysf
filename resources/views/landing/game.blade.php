        ...
        <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="item">
                <div class="icon">
                  <img src="{{asset('cyborg/assets/images/service-01.jpg')}}" alt="" style="max-width: 60px; border-radius: 50%;">
                </div>
            ...
            <div class="col-lg-4">
              <div class="item">
                <div class="icon">
                  <img src="{{asset('cyborg/assets/images/service-02.jpg')}}" alt="" style="max-width: 60px; border-radius: 50%;">
                </div>
            ...
            <div class="col-lg-4">
              <div class="item">
                <div class="icon">
                  <img src="{{asset('cyborg/assets/images/service-03.jpg')}}" alt="" style="max-width: 60px; border-radius: 50%;">
                </div>
                <h4>You Are Live</h4>
