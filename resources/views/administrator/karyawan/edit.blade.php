                        ...
                        <div class="row">
                            <div class="col-md-3 col-6">
                                <div class="form-group mandatory">
                                    ...
                                    <input type="text" id="inputNamaDepan" class="form-control" placeholder="Masukan Nama Depan" value="{{$data->nama_depan}}"
                            ...
                            <div class="col-md-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputNamaBelakang" class="form-control" placeholder="Masukan Nama Belakang" value="{{$data->nama_belakang}}"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group mandatory">
                                    ...
                                    <input type="text" id="inputNama" class="form-control" placeholder="Masukan Nama Lengkap" value="{{$data->nama}}"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group mandatory">
                                    ...
                                    <input type="text" id="inputEmail" class="form-control" placeholder="Masukan Email" value="{{$data->email}}"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group mandatory">
                                    ...
                                    <input type="text" id="inputTelepon" class="form-control" placeholder="Masukan Telepon" value="{{$data->telepon}}"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" id="inputTanggalLahir" class="form-control datepicker" value="{{date('d-m-Y', strtotime($data->tanggal_lahir))}}"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" id="inputTanggalBergabung" class="form-control datepicker" value="{{date('d-m-Y', strtotime($data->tanggal_bergabung))}}"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="inputKeterangan" class="form-control" placeholder="Masukkan Keterangan" name="keterangan" style="height: 150px;">{{$data->keterangan}}</textarea>
                                </div>
                            </div>
                        </div>
