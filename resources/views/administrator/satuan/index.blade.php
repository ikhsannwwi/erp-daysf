...
@section('content')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        @if (isallowed('satuan', 'add'))
                            <a href="{{ route('admin.satuan.add') }}" class="btn btn-primary mx-3 float-end">Tambah
                                Data</a>
                        @endif
            ...
            {{-- @include('administrator.satuan.filter.main') --}}
            <div class="card-body">
    ...
    {{-- @include('administrator.satuan.modal.detail') --}}
@endsection
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var data_table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.satuan.getData') }}',
                    dataType: "JSON",
                    type: "GET",
                },
                columns: [{
