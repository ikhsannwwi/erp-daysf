    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('admin.satuan.update') }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" id="inputNama" class="form-control" value="{{$data->nama}}"
                                                placeholder="cth : Kilogram" name="nama" autocomplete="off"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" id="inputAlias" class="form-control" value="{{$data->alias}}"
                                                placeholder="cth : kg" name="alias" autocomplete="off"
                                                data-parsley-required="true">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end">
                                ...
                                <a href="{{route('admin.satuan')}}" class="btn btn-danger me-1 mb-1">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            async function validateRemoteNama() {
                ...
                const remoteValidationUrl = "{{ route('admin.satuan.checkNama') }}";
