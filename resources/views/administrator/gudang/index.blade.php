...
@section('content')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        @if (isallowed('gudang', 'add'))
                            <a href="{{ route('admin.gudang.add') }}" class="btn btn-primary mx-3 float-end">Tambah
                                Data</a>
                        @endif
            ...
            {{-- @include('administrator.gudang.filter.main') --}}
            <div class="card-body">
    ...
    @include('administrator.gudang.modal.detail')
@endsection
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var data_table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.gudang.getData') }}',
                    dataType: "JSON",
                    type: "GET",
                },
                columns: [{
