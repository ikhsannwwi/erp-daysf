        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        @if (isallowed('member', 'add'))
                            <a href="{{ route('admin.member.add') }}" class="btn btn-primary me-3 float-end">Tambah
                                Data</a>
                        @endif
                        @if (isallowed('member', 'arsip'))
                            <a href="{{ route('admin.member.arsip') }}" class="btn btn-primary mx-3 float-end">Arsip</a>
                        @endif
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var data_table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.member.getData') }}',
                    dataType: "JSON",
                    type: "GET",
                    data: function(d) {
                        d.status = getStatus();
