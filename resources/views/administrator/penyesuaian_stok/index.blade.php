...
@section('content')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        @if (isallowed('penyesuaian_stok', 'add'))
                            <a href="{{ route('admin.penyesuaian_stok.add') }}" class="btn btn-primary mx-3 float-end">Tambah
                                Data</a>
                        @endif
            ...
            {{-- @include('administrator.penyesuaian_stok.filter.main') --}}
            <div class="card-body">
    ...
    @include('administrator.penyesuaian_stok.modal.detail')
@endsection
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var data_table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.penyesuaian_stok.getData') }}',
                    dataType: "JSON",
                    type: "GET",
                },
                columns: [{
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('admin.penyesuaian_stok.delete') }}",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                "_method": "DELETE",
                                "id": id,
                            ...
                            success: function() {
                                // data_table.ajax.url(
                                //         '{{ route('admin.penyesuaian_stok.getData') }}')
                                //     .load();
