                    ...
                    <div class="col-6">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.transaksi_stok_toko') }}">Transaksi Stok Toko</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">{{ $toko->nama }}</li>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var data_table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.transaksi_stok_toko.getData') }}',
                    dataType: "JSON",
                    type: "GET",
                    data: {
                        produk_id: {{ $data->id }},
