...
@section('content')
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.stok_opname_toko') }}">Stok Opname Toko</a></li>
            ...
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('admin.stok_opname_toko.save') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end">
                                ...
                                <a href="{{ route('admin.stok_opname_toko') }}" class="btn btn-danger me-1 mb-1">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    @include('administrator.stok_opname_toko.modal.toko')
    @include('administrator.stok_opname_toko.modal.karyawan')
@endsection
        ...
        $(document).ready(function() {
            ...
            submitButton.addEventListener("click", async function(e) {
                ...
                if (!tbody || !tbody.childElementCount) {
                    ...
                    accessErrorDetail.text(
                        'Setidaknya harus ada salah satu detail Stok Opname Toko'
            ...
            $('#ModalProduk').on('show.bs.modal', function(event) {
                ...
                var data_table_produk = $('#datatableProdukModal').DataTable({
                    ...
                    ajax: {
                        url: '{{ route('admin.stok_opname_toko.getDataProduk') }}',
                        dataType: "JSON",
                        type: "GET",
                    },
                    'columnDefs': [{
                ...
                $(".detail-list").each(function() {
                    ...
                    $(this).find('.jumlah_stok_fisik-item').on('keyup', function(){
                        ...
                        if (stok_fisik > stok){
                            ...
                            swalWithBootstrapButtons.fire({
                                title: 'Failed!',
                                text: 'Jumlah stok fisik tidak boleh melebihi stok toko.',
                                icon: 'error',
