...
@section('content')
    ...
    <section class="section">
        <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        @if (isallowed('produksi', 'add'))
                            <a href="{{ route('admin.produksi.add') }}" class="btn btn-primary mx-3 float-end">Tambah
                                Data</a>
                        @endif
            ...
            {{-- @include('administrator.produksi.filter.main') --}}
            <div class="card-body">
    ...
    @include('administrator.produksi.modal.detail')
@endsection
