    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalProdukLabel">Data Produk Produksi</h5>
...
@push('js')
    <script type="text/javascript">
        function addSelectedClassByProduk(id) {
        ...
        $('#ModalProduk').on('show.bs.modal', function(event) {
            ...
            var data_table = $('#datatableProdukModal').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.produksi.getDataProduk') }}',
                    dataType: "JSON",
                    type: "GET",
                },
                columns: [{
            ...
            $('#selectDataProduk').on('click', function() {
                ...
                if (selectedRow) {
                    ...
                    if ($("#inputProduk").val() !== '') {
                        $('#triggerFormula').removeClass('data_disabled')
                    }else{
                        $('#triggerFormula').addClass('data_disabled')
                    }
                }
