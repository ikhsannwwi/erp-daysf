    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('admin.produksi.save') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text pb-3" id="searchFormula"><i
                                                class="bi bi-search"></i></span>
                                        <input type="text" class="form-control" id="inputFormulaName"
                                            data-parsley-required="true" readonly>
                                        <input type="text" class="d-none" name="formula" id="inputFormula">
                                        <div class="input-group-append">
                                            <!-- Menggunakan input-group-append agar elemen berikutnya ditambahkan setelah input -->
                                            <a href="#" class="btn btn-outline-secondary data_disabled" data-bs-toggle="modal"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" id="inputJumlahProduksi" class="form-control text-end"
                                                placeholder="Masukan Jumlah Produksi" name="jumlah_produksi"
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $.each(datas, function(i, data) {
                                    ...
                                    tr_clone.find(".input_id-item").val(data
                                    .id);
