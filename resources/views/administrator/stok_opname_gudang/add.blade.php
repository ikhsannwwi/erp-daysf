...
@section('content')
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.stok_opname_gudang') }}">Stok Opname Gudang</a></li>
            ...
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('admin.stok_opname_gudang.save') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="form-group mandatory">
                                <div class="col-md-4 col-12">
                                    <label for="triggerKaryawan" class="form-label">Karyawan</label>
                                    <div class="input-group">
                                        <span class="input-group-text pb-3" id="searchKaryawan"><i
                                                class="bi bi-search"></i></span>
                                        <input type="text" class="form-control" id="inputKaryawanName"
                                            data-parsley-required="true" readonly>
                                        <input type="text" class="d-none" name="karyawan" id="inputKaryawan">
                                        <div class="input-group-append">
                                            ...
                                            <a href="#" class="btn btn-outline-secondary" data-bs-toggle="modal"
                                                data-bs-target="#ModalKaryawan" id="triggerKaryawan">
                                                Search
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="inputNama" class="form-label">Opname</label>
                                        </div>
                                        ...
                                        <table class="table" id="daftar_detail">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="100px">Stok Gudang</th>
                                                    <th width="100px">Jumlah stok fisik</th>
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end">
                                ...
                                <a href="{{ route('admin.stok_opname_gudang') }}" class="btn btn-danger me-1 mb-1">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <table class="template-detail" style="display: none;">
        <tr class="template-detail-list" childidx="0" style="position: relative;">
            ...
            <td><input type="text" name="detail[0][jumlah_stok_fisik]" class="form-control text-end jumlah_stok_fisik-item"
                    data-parsley-required="true" autocomplete="off" id="inputJumlahStokFisik">
            </td>
            <td><input type="text" name="detail[0][selisih]" class="form-control text-end selisih-item"
                    data-parsley-required="true" autocomplete="off" id="inputSelisih" readonly></td>
    ...
    @include('administrator.stok_opname_gudang.modal.gudang')
    @include('administrator.stok_opname_gudang.modal.karyawan')
@endsection
        ...
        $(document).ready(function() {
            ...
            submitButton.addEventListener("click", async function(e) {
                ...
                if (!tbody || !tbody.childElementCount) {
                    ...
                    accessErrorDetail.text(
                        'Setidaknya harus ada salah satu detail Stok Opname Gudang'
            ...
            $('#ModalProduk').on('show.bs.modal', function(event) {
                ...
                var data_table_produk = $('#datatableProdukModal').DataTable({
                    ...
                    ajax: {
                        url: '{{ route('admin.stok_opname_gudang.getDataProduk') }}',
                        dataType: "JSON",
                        type: "GET",
                    },
                    'columnDefs': [{
                        ...
                        $('#datatableProdukModal tbody tr.selected').each(function() {
                            ...
                            if (data_i && data_i.id) {
                                ...
                                if (!daftar_detail_ids.includes(data_i.id.toString())) {
                                    ...
                                    tr_clone.find(".nama_satuan-item").text(data_i.satuan.nama);
            ...
            function resetData() {
                ...
                $(".detail-list").each(function() {
                    ...
                    $(this).find('.jumlah_stok_fisik-item').inputmask('currency', {
                        rightAlign: false,
                        prefix: '',
                        digits: 0,
                        groupSeparator: ',',
                    ...
                    $(this).find('.selisih-item').inputmask('currency', {
                        rightAlign: false,
                        prefix: '',
                        digits: 0,
                        groupSeparator: ',',
                    ...
                    $(this).find('.jumlah_stok_fisik-item').on('keyup', function(){
                        let stok = parseInt($(another).find('.stok_tersedia-item').text())
                        let stok_fisik = parseInt(parseNumber($(this).val()))
                        let selisih = stok - stok_fisik
                        $(another).find('.selisih-item').val(selisih)
                        if (stok_fisik > stok){
                            $(this).val('')
                            $(another).find('.selisih-item').val('')
                            ...
                            swalWithBootstrapButtons.fire({
                                title: 'Failed!',
                                text: 'Jumlah stok fisik tidak boleh melebihi stok gudang.',
                                icon: 'error',
