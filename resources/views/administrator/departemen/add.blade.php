...
@section('content')
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.departemen') }}">Departemen</a></li>
            ...
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('admin.departemen.save') }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" id="inputNama" class="form-control"
                                                placeholder="Masukan Nama Departemen" name="nama" autocomplete="off"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="inputDeskripsi" class="form-control" placeholder="Masukkan Deskripsi" name="deskripsi" style="height: 150px;"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group ">
                                <div class="col-md-4 col-12">
                                    <label for="triggerKaryawan" class="form-label">Kepala Departemen</label>
                                    <div class="input-group">
                                        <span class="input-group-text pb-3" id="searchKaryawan"><i
                                                class="bi bi-search"></i></span>
                                        <input type="text" class="form-control" id="inputKaryawanName" readonly>
                                        <input type="text" class="d-none" name="kepala_departemen" id="inputKaryawan">
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end">
                                ...
                                <a href="{{route('admin.departemen')}}" class="btn btn-danger me-1 mb-1">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    @include('administrator.departemen.modal.karyawan')
    <!-- Basic Tables end -->
@endsection
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            async function validateRemoteNama() {
                const inputNama = $('#inputNama');
                const remoteValidationUrl = "{{ route('admin.departemen.checkNama') }}";
