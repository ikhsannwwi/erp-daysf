...
@section('content')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        @if (isallowed('departemen', 'add'))
                            <a href="{{ route('admin.departemen.add') }}" class="btn btn-primary mx-3 float-end">Tambah
                                Data</a>
                        @endif
            ...
            {{-- @include('administrator.departemen.filter.main') --}}
            <div class="card-body">
    ...
    {{-- @include('administrator.departemen.modal.detail') --}}
@endsection
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var data_table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.departemen.getData') }}',
                    dataType: "JSON",
                    type: "GET",
                },
                columns: [{
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function() {
                                // data_table.ajax.url(
                                //         '{{ route('admin.departemen.getData') }}')
                                //     .load();
