...
@section('content')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        @if (isallowed('formula', 'add'))
                            <a href="{{ route('admin.formula.add') }}" class="btn btn-primary mx-3 float-end">Tambah
                                Data</a>
                        @endif
            ...
            {{-- @include('administrator.formula.filter.main') --}}
            <div class="card-body">
    ...
    @include('administrator.formula.modal.detail')
@endsection
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var data_table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.formula.getData') }}',
                    dataType: "JSON",
                    type: "GET",
                },
                columns: [{
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('admin.formula.delete') }}",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                "_method": "DELETE",
                                "id": id,
