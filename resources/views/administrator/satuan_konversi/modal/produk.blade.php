    ...
    <script type="text/javascript">
        ...
        $('#ModalProduk').on('show.bs.modal', function(event) {
            ...
            var data_table = $('#datatableProdukModal').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.satuan_konversi.getDataProduk') }}',
                    dataType: "JSON",
                    type: "GET",
                },
                columns: [{
            ...
            $('#selectDataProduk').on('click', function() {
                ...
                if (selectedRow) {
                    ...
                    $("#inputKuantitasSatuan").val('');
                    $("#inputNamaKonversi").val('');
                    $("#inputNamaSatuan").val(selectedRow.satuan.nama);
                    $("#inputSatuanId").val(selectedRow.satuan_id);
                }
