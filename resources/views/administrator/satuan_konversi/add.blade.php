    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('admin.satuan_konversi.save') }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-2 col-3">
                                        <div class="form-group mandatory">
                                            <input type="text" id="inputKuantitasSatuan" class="form-control text-end"
                                                placeholder="Kuantitas Satuan" name="kuantitas_satuan" autocomplete="off"
                                    ...
                                    <div class="col-md-2 col-3">
                                        <div class="form-group mandatory">
                                            <input type="text" id="inputNamaSatuan" class="form-control"
                                                placeholder="Nama Satuan" name="nama_satuan" autocomplete="off"
                                                data-parsley-required="true" readonly>
                                                <input type="hidden" id="inputSatuanId" name="satuan_id">
                                        </div>
                                    </div>
                                </div>
                            </div>
