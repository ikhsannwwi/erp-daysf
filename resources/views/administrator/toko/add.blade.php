    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('admin.toko.save') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group mandatory">
                                    ...
                                    <input type="text" id="inputNama" class="form-control" placeholder="Masukan Nama Toko"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" id="inputPenanggungJawab" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end">
                                ...
                                <a href="{{ route('admin.toko') }}" class="btn btn-danger me-1 mb-1">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            async function validateRemoteEmail() {
                const inputNama = $('#inputNama');
                const remoteValidationUrl = "{{ route('admin.toko.checkName') }}";
