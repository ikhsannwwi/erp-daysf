    ...
    <script type="text/javascript">
        ...
        $('#ModalSatuan').on('show.bs.modal', function(event) {
            ...
            var data_table = $('#datatableSatuanModal').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.pembelian.getDataSatuan') }}',
                    dataType: "JSON",
                    type: "GET",
                    data: {
                        "_token": "{{ csrf_token() }}",
                ...
                drawCallback: function(settings) {
                    let childidx = $('#selectDataSatuan').data('childidx');
                    let targetRow = $('#daftar_detail tbody tr[childidx="' + childidx + '"]');
                    var id = targetRow.find(".satuan_id-item").val();
            ...
            $('#selectDataSatuan').off().on('click', function() {
                ...
                if (selectedRow) {
                    ...
                    targetRow.find(".nama_satuan-item").text(selectedRow.nama);
                    targetRow.find(".satuan_id-item").val(selectedRow.id);
                }
