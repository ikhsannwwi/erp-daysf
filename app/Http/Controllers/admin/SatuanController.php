...
class SatuanController extends Controller
{
    ...
    public function index(){
        ...
        return view('administrator.satuan.index');
    }
        ...
        return DataTables::of($data)
            ->addColumn('action', function ($row) {
                ...
                if (isAllowed(static::$module, "edit")) : //Check permission
                    $btn .= '<a href="'.route('admin.satuan.edit',$row->id).'" class="btn btn-primary btn-sm me-3 ">
                    Edit
                </a>';
                endif;
                return $btn;
    ...
    public function add(){
        ...
        return view('administrator.satuan.add');
    }
    ...
    public function save(Request $request){
        ...
        return redirect()->route('admin.satuan')->with('success', 'Data berhasil disimpan.');
    }
    ...
    public function edit($id){
        ...
        return view('administrator.satuan.edit',compact('data'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.satuan')->with('success', 'Data berhasil diupdate.');
    }
    ...
    public function checkNama(Request $request){
        if($request->ajax()){
            $users = Satuan::where('nama', $request->nama);
