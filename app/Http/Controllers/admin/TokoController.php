...
class TokoController extends Controller
{
    ...
    public function index(){
        ...
        return view('administrator.toko.index');
    }
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) {
                ...
                if (isAllowed(static::$module, "edit")) : //Check permission
                    $btn .= '<a href="'.route('admin.toko.edit',$row->id).'" class="btn btn-primary btn-sm me-3 ">
                    Edit
                </a>';
                endif;
                if (isAllowed(static::$module, "detail")) : //Check permission
                    $btn .= '<a href="#" data-id="' . $row->id . '" class="btn btn-secondary btn-sm me-3" data-bs-toggle="modal" data-bs-target="#detailToko">
                    Detail
                </a>';
                endif;
                return $btn;
    ...
    public function add(){
        ...
        return view('administrator.toko.add');
    }
    ...
    public function save(Request $request){
        ...
        return redirect()->route('admin.toko')->with('success', 'Data berhasil disimpan.');
    }
    ...
    public function edit($id){
        ...
        return view('administrator.toko.edit',compact('data'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.toko')->with('success', 'Data berhasil diupdate.');
    }
    ...
    public function changeStatus(Request $request)
    {
        ...
        $log = $request->status;
        $id = $request->ix;
        $updates = Toko::where(["id" => $id])->first();
        // Simpan data sebelum diupdate
    ...
    public function checkName(Request $request){
        if($request->ajax()){
            $data = Toko::where('nama', $request->nama);
