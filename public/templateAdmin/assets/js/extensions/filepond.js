                ...
                !(function (e) {
                    ...
                    var t = function (e) {
                        ...
                        ne = function (e, t, n, r, i) {
                            ...
                            return (
                                (o.withCredentials = W(o.withCredentials)), o
                            );
                        },
                        re = function (e) {
                            return null === e;
                    ...
                    var we = function (e, t) {
                        ...
                        tt = [
                            Ge.LOAD_ERROR,
                            Ge.PROCESSING_ERROR,
                            Ge.PROCESSING_REVERT_ERROR,
                        ],
                        nt = [
                            Ge.LOADING,
                            Ge.PROCESSING,
                            Ge.PROCESSING_QUEUED,
                            Ge.INIT,
                        ],
                        ...
                        st = function (e) {
                            return (
                                ie(e.options.server) &&
                                (ie(e.options.server.process) ||
                                    $(e.options.server.process))
                            );
                        },
                        ut = function (e) {
                            return {
                                ...
                                GET_PANEL_ASPECT_RATIO: function () {
                                    return /circle/.test(
                                        ...
                                        ? 1
                                        : Qe(e.options.stylePanelAspectRatio);
                                },
                        ...
                        Nt = function (e, t, n) {
                            ...
                            return (
                                ((Ct(n.method) ? a : a.upload).onprogress =
                                    function (e) {
                                        i ||
                                            r.onprogress(
                                                e.lengthComputable,
                        ...
                        Zt = function (e) {
                            ...
                            return (
                                e instanceof Blob || pt(e)
                                    ? (t[0] = e.name || gt())
                                    : pt(e)
                                    ? ((t[1] = e.length), (t[2] = Rt(e)))
                                    : j(e) &&
                                      ((t[0] = Et(e)),
                                      (t[1] = 0),
                        ...
                        fn = function (e, t, n) {
                            return {
                                ...
                                REQUEST_ITEM_PROCESSING: cn(
                                    n,
                                    function (r, i, o) {
                                        if (
                                            r.status === Ge.IDLE ||
                                            r.status === Ge.PROCESSING_ERROR
                                        )
                                            r.status !== Ge.PROCESSING_QUEUED &&
                                                (r.requestProcessing(),
                                                e(
                                ...
                                PROCESS_ITEM: cn(n, function (r, i, o) {
                                    ...
                                    if (
                                        t("GET_ITEMS_BY_STATUS", Ge.PROCESSING)
                                            .length !== a
                                    ) {
                                ...
                                REQUEST_REMOVE_ITEM: cn(n, function (n) {
                                    un(t("GET_BEFORE_REMOVE_FILE"), Ce(n)).then(
                                        function (t) {
                                ...
                                REQUEST_REVERT_ITEM_PROCESSING: cn(
                                    n,
                                    function (r) {
                        ...
                        In = G({
                            ...
                            write: function (e) {
                                ...
                                if (0 !== n.opacity) {
                                    n.align &&
                                        (t.element.dataset.align = n.align);
                                    var r = parseInt(
                        ...
                        Rn = function (e) {
                            ...
                            (i.className = "filepond--file-info-sub"),
                                ...
                                hn(r, pn(t.query("GET_ITEM_NAME", n.id)));
                        },
                        On = function (e) {
                            var t = e.root,
                                n = e.props;
                            hn(
                                ...
                                hn(
                                    t.ref.fileName,
                                    pn(t.query("GET_ITEM_NAME", n.id))
                                );
                        },
                        An = function (e) {
                            var t = e.root,
                                n = e.props;
                            Q(t.query("GET_ITEM_SIZE", n.id))
                                ? On({ root: t, props: n })
                                : hn(
                                      t.ref.fileSize,
                                      t.query(
                        ...
                        wn = function (e) {
                            ...
                            (r.className = "filepond--file-status-sub"),
                                t.appendChild(r),
                                (t.ref.sub = r),
                                Ln({ root: t, action: { progress: null } });
                        },
                        Ln = function (e) {
                            var t = e.root,
                                n = e.action,
                        ...
                        Pn = function (e) {
                            var t = e.root,
                                n = e.action;
                            hn(t.ref.main, n.status.main),
                                hn(t.ref.sub, n.status.sub);
                        },
                        bn = G({
                            name: "file-status",
                            ignoreRect: !0,
                    ...
                    var Gn,
                        ...
                        zn = {
                            DID_THROW_ITEM_INVALID: {
                                buttonRemoveItem: { opacity: 1 },
                                info: { translateX: xn },
                                status: { translateX: xn, opacity: 1 },
                            },
                            DID_START_ITEM_LOAD: {
                            ...
                            DID_THROW_ITEM_REMOVE_ERROR: {
                                ...
                                buttonRemoveItem: { opacity: 1 },
                                info: { translateX: xn },
                                status: { opacity: 1, translateX: xn },
                            },
                            DID_LOAD_ITEM: kn,
                            DID_LOAD_LOCAL_ITEM: {
                                buttonRemoveItem: { opacity: 1 },
                        ...
                        jn = function (e) {
                            ...
                            if (
                                ...
                                (E.info.translateX = Bn),
                                    (E.info.translateY = Un),
                                    (E.status.translateY = Un),
                            ...
                            if (
                                (f &&
                                    ...
                                    (zn.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX =
                                        Fn)),
                                d && s)
                            ) {
                                ...
                                (h.info.translateX = xn),
                                    (h.status.translateY = Un),
                        ...
                        or = function (e) {
                            ...
                            if (
                                ...
                                (t.ref.container = t.appendChildView(
                                    t.createChildView(Qn, { id: n.id })
                                )),
                                (t.ref.panel = t.appendChildView(
                                    t.createChildView(er, {
                                        name: "item-panel",
                                    })
                                )),
                        ...
                        Lr = function (e) {
                            ...
                            e.action.value
                                ? 0 === t.query("GET_TOTAL_ITEMS") &&
                                  yr(t.element, "required", !0)
                                : yr(t.element, "required", !1);
                        },
                        Mr = function (e) {
                            var t = e.root,
                                n = e.action;
                        ...
                        Mi = function (e) {
                            wi.includes(e) ||
                                ...
                                Si ||
                                    ((Si = !0),
                                    document.addEventListener("paste", Li)));
                        },
                        Pi = function (e) {
                            we(wi, wi.indexOf(e)),
                                0 === wi.length &&
                                    (document.removeEventListener("paste", Li),
                                    (Si = !1));
                        },
                        bi = function () {
                            var e = function (e) {
                        ...
                        Hi = function (e) {
                            ...
                            i &&
                                ...
                                (t.ref.list = t.appendChildView(
                                    t.createChildView(vr, { translateY: null })
                                )),
                                (t.ref.panel = t.appendChildView(
                                    t.createChildView(er, {
                                        name: "panel-root",
                                ...
                                (t.ref.assistant = t.appendChildView(
                                    t.createChildView(ki, Object.assign({}, n))
                                )),
                                (t.ref.data = t.appendChildView(
                                    t.createChildView(Xr, Object.assign({}, n))
                                )),
                            ...
                            t.query("GET_ALLOW_REORDER") &&
                                a &&
                                !o &&
                                (t.element.addEventListener("touchmove", ji, {
                                    passive: !1,
                                }),
                        ...
                        po = function () {
                            return t(
                                ...
                                ? fo.apply(void 0, arguments)
                                : ao.apply(void 0, arguments);
                        },
                    ...
                    if (
                        ...
                        (e.Status = Object.assign({}, $e)),
                            ...
                            (e.destroy = function (e) {
                                ...
                                return (
                                    t >= 0 &&
                                    (bo.apps.splice(t, 1)[0].restoreElement(),
                                    !0)
                                );
                            }),
                            (e.parse = function (t) {
                            ...
                            (t.lib = t.prototype =
                                {
                                    ...
                                    buildToast: function () {
                                        ...
                                        for (const t in this.options.style)
