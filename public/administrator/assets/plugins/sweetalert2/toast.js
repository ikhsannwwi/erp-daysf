...
;(function () {
    ...
    var _defaults = {
        ...
        sounds: {
            ...
            info: "http://127.0.0.1:8000/administrator/assets/plugins/toasty/sounds/info/1.mp3",
            // path to sound for successfull message:
            success: "http://127.0.0.1:8000/administrator/assets/plugins/toasty/sounds/success/1.mp3",
            // path to sound for warn message:
            warning: "http://127.0.0.1:8000/administrator/assets/plugins/toasty/sounds/warning/1.mp3",
            // path to sound for error message:
            error: "http://127.0.0.1:8000/administrator/assets/plugins/toasty/sounds/error/1.mp3",
        },
    ...
    var playSound = function (type, container, sounds, playerclass) {
        console.log('Trying to play sound:', type,);
        ...
        audio.innerHTML = '<source src="' + sound + '" type="audio/mpeg"/>' +
                          '<embed hidden="true" autoplay="true" loop="false" src="' + sound + '" />';
    ...
    /**
     * Hide the toast message with SweetAlert.
     *
     * @return void
     */
